...
- docs-multipage: page specs byte-compare against `docs/guide.html`, which a later leaf deletes; the deleting leaf must retire every spec reading it in the same diff. 2026-09-11. history/2026-09-11-guide-source-spec.md
