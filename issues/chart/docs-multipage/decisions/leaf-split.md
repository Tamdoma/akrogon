...
## Findings
- Pages are independently checkable once the shell exists. Only the shell is an actual prerequisite.
- The in-practice page depends on a real seed-to-merge run, which the shell leaf could be.
