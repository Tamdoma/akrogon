...
## What
Create `docs/install.html`, `docs/setup.html`, `docs/create.html`, `docs/next.html` and `docs/merge.html` from the sections of the same ids in guide.html, using the shell from `docs/idea.html`.

## Why
The operating sections become their own pages so the guide is no longer one long scroll.
