...
## Forks taken
- [Which areas of akrogon get an area file in this issue?](forks/area-coverage.md): src, skills, tests
- [How is the work split into leaves?](forks/leaf-split.md): one leaf
- [Where does an area file live and what is it called?](forks/area-file-location.md): `<area>/AREA.md` beside the code
- [Where is the dead-path check enforced?](forks/path-check-home.md): check-issue review rule, diff-scoped
