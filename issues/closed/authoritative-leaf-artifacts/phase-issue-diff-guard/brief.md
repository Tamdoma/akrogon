...
5. Test: the existing review-time behavior at `tests/phase.test.ts:127-155` (issue files refused at review) and the empty-branch refusal at `tests/phase.test.ts:780-795` both still pass unchanged.
