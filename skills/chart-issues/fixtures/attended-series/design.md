...
- Answer: use the direct handoff shape.
- Reason: the chart already settled the route.
- Foreclosed alternatives: per-leaf create-issue grilling.
...
This fixture has no production implementation.
