...
This reference defines the objective advisory quality pass used by `implement-issue` and `check-issue`, and the execution-constraint source `consult-issue` incorporates during implementation synthesis and verifies during the fidelity audit.
