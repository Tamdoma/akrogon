...
Create the Claude environment file at:

```text
~/.claude/skills/broadcast-issue/.env
```
...
2. `~/.claude/skills/broadcast-issue/.env`.
...
```bash
echo '{"summary":"Test broadcast","whats_new":["First visible change","Second visible change","Third visible change"]}' | bun ~/.claude/skills/broadcast-issue/scripts/discord-send.js --dry-run
```
...
```bash
echo '{"summary":"Test broadcast","whats_new":["First visible change","Second visible change","Third visible change"]}' | bun ~/.claude/skills/broadcast-issue/scripts/discord-send.js
```
